...
function updateMenuDisplay(dateKey) {
  ...
  // Find Bruin Plate data in the menu
  const bruinPlateMenus = dayData.filter(venue => 
    venue && venue.storeName && venue.storeName === "Bruin Plate"
  );
  ...
  // Process each Bruin Plate menu
  bruinPlateMenus.forEach(menu => {
      ...
      menu.menuWeeks.forEach(week => {
        ...
        week.menuDays.forEach(day => {
          ...
          day.menuDayMealOptions.forEach(mealOption => {
            ...
            if (!processedData[mealType][categoryName]) {
              processedData[mealType][categoryName] = [];
            }
            ...
            mealOption.menuRows.forEach(row => {
              ...
              processedData[mealType][categoryName].push({
